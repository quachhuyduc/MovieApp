...
public class UpComingAdapter extends RecyclerView.Adapter<UpComingAdapter.ViewHolder> {
    private List<NowPlayingMovie> mMovieUpComing;
    ...
    public UpComingAdapter(Context context, OnMovieListener listener) {
    ...
    public void setDataUpComing(List<NowPlayingMovie> mMovieUpComing) {
        this.mMovieUpComing = mMovieUpComing;
    ...
    public void onBindViewHolder(@NonNull UpComingAdapter.ViewHolder holder, int position) {
        ...
        NowPlayingMovie nowPlayingMovie = mMovieUpComing.get(position);

        String name = nowPlayingMovie.getTitle();
        String releaseDate = nowPlayingMovie.getReleaseDate();
        int movieId = nowPlayingMovie.getId();

        holder.tv_movieName.setText(mMovieUpComing.get(position).getTitle());
        holder.tv_originalLanguage.setText(mMovieUpComing.get(position).getReleaseDate());


        holder.tv_voteAverage.setText(mMovieUpComing.get(position).getVoteAverage()+"");

        Glide.with(holder.itemView.getContext())
                .load("https://image.tmdb.org/t/p/w500/" + mMovieUpComing.get(position).getPosterPath())
    ...
    public int getItemCount() {
        return (mMovieUpComing != null) ? mMovieUpComing.size() : 0;
    }
